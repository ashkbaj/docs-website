...
| `@aws-sdk/client-bedrock-runtime` | 3.474.0 | 3.637.0 | 11.13.0 |
...
| `@langchain/core` | 0.1.17 | 0.2.30 | 11.13.0 |
| `@nestjs/cli` | 9.0.0 | 10.4.4 | 10.1.0 |
| `@prisma/client` | 5.0.0 | 5.19.0 | 11.0.0 |
